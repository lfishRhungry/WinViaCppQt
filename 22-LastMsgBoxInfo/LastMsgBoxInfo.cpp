...
#include <windowsx.h>
#include <tchar.h>
#include "../22-LastMsgBoxInfoLib/22-LastMsgBoxInfoLib.h"
#pragma comment(lib, "22-LastMsgBoxInfoLib.lib")

LastMsgBoxInfo::LastMsgBoxInfo(QWidget *parent)
	: QWidget(parent)
{
	ui.setupUi(this);
	//---------------------------界面设计-------------------------------
...
LastMsgBoxInfo::~LastMsgBoxInfo() {
	LastMsgBoxInfo_HookAllApps(FALSE, 0);
}

bool LastMsgBoxInfo::nativeEvent(const QByteArray& eventType, void* message, long* result) {
